                    ...
                    <div class="flex flex-col justify-between grow">
                        ...
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="-mx-2 space-y-1">
                                ...
                                <a href="#"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 {{ request()->is("/admin-panel/team") ? "bg-indigo-700" : "hover:bg-indigo-700"}}">
                                ...
                                <a href="#"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 {{ request()->is("/admin-panel/projects") ? "bg-indigo-700" : "hover:bg-indigo-700"}}">
                                ...
                                <a href="#"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 {{ request()->is("/admin-panel/calendar") ? "bg-indigo-700" : "hover:bg-indigo-700"}}">
            ...
            <div
                ...
                <div class="flex flex-row items-center gap-2">
                    ...
                    <div class="flex items-center">
                        ...
                        <img class="bg-gray-100 rounded-full size-8 lg:mr-4" src="{{ userImage() }}"
                            alt="User Image">
