    ...
    <div class="lg:px-8 sm:px-6 px-4 sm:pb-24 pb-16 sm:pt-8 pt-4 max-w-[80rem] mx-auto">
        ...
        <div class="grid lg:grid-cols-2 grid-cols-1 lg:max-w-none max-w-[32rem] gap-y-16 gap-x-8 mx-auto">
                            ...
                            <div class="sm:ml-6 ml-4 flex flex-row justify-between flex-1">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <p class="text-gray-900 font-medium text-sm">${{ $product->price }}</p>
                                    </div>
            ...
            <div class="max-w-[32rem] w-full mx-auto">
                ...
                <a href="/checkout/paid?orderCode={{ $orderCode }}" class="flex justify-center items-center w-full py-2 bg-black border border-transparent rounded-md">
                ...
                <form class="space-y-6" action="/checkout/pay" method="post" novalidate>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input class="text-sm py-1.5 px-3 block w-full rounded-md bg-white outline outline-1 -outline-offset-1 outline-gray-300" type="text" name="nameOfCard" id="nameOfCard" value="{{ $old('nameOfCard') }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input class="text-sm py-1.5 px-3 block w-full rounded-md bg-white outline outline-1 -outline-offset-1 outline-gray-300" type="text" name="cardNumber" id="cardNumber" value="{{ $old('cardNumber') }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input class="text-sm py-1.5 px-3 block w-full rounded-md bg-white outline outline-1 -outline-offset-1 outline-gray-300" type="text" name="expirationDate" id="expirationDate" value="{{ $old('expirationDate') }}">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input class="text-sm py-1.5 px-3 block w-full rounded-md bg-white outline outline-1 -outline-offset-1 outline-gray-300" type="text" name="cvc" id="cvc" value="{{ $old('cvc') }}">
                        </div>
                    </div>

                    @if ($errors->has('error'))
                        <p class="text-xs text-red-500 mt-1 pl-2.5">{{ $errors->first("error") }}</p>
                    @endif
