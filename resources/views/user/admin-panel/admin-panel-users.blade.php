                        ...
                        <table class="min-w-full">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="sm:pl-0 text-gray-900 whitespace-nowrap font-semibold text-sm text-left pl-4 pr-3 py-3.5">Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="sm:pl-0 text-gray-900 whitespace-nowrap font-medium text-sm pl-4 pr-3 py-4">Koorosh</td>
                                    <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">kooroshsoleymani98@gmail.com</td>
                                    ...
                                    <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">2023</td>
                                    <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">2024</td>
                                    <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">
                                        <a href="/admin-panel/users/edit" class="text-indigo-600">edit</a>
                                    </td>
                                    <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">
                                        <a href="/admin-panel/users/edit" class="text-red-600">delete</a>
                                    </td>
                                    <td class="sm:pr-0 whitespace-nowrap font-medium text-sm text-right pl-3 pr-4 py-4 relative">
                                        <a href="/admin-panel/users/edit" class="text-red-800">ban</a>
                                    </td>
