                            ...
                            <tbody class="divide-y">
                                ...
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">{{ $category->name }}</td>
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">
                                            <a href="/admin-panel/categories/edit?{{ "id={$category->id}" }}" class="text-indigo-600">edit</a>
                                        </td>
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">
                                            <a href="/admin-panel/categories/delete?{{ "id={$category->id}" }}" class="text-red-500">delete</a>
                                        </td>
