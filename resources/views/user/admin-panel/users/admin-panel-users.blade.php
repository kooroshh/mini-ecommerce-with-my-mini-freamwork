                            ...
                            <tbody class="divide-y">
                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="sm:pl-0 text-gray-900 whitespace-nowrap font-medium text-sm pl-4 pr-3 py-4"><img class="size-6 rounded-full" src="{{ image($user->image, "users") }}" alt="User Image"></td>
