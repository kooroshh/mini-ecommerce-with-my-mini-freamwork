                            ...
                            <tbody class="divide-y">
                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">{{ $product->created_at }}</td>
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">{{ $product->updated_at }}</td>
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">
                                            <a href="/admin-panel/products/edit?{{ "id={$product->id}" }}" class="text-indigo-600">edit</a>
                                        </td>
                                        <td class="text-gray-500 whitespace-nowrap text-sm py-4 px-3">
                                            <a href="/admin-panel/products/delete?{{ "id={$product->id}" }}" class="text-red-500">delete</a>
                                        </td>
