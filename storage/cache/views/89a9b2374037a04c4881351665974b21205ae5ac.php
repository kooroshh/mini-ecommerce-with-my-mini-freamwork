...
<a href="/admin-panel/users" class="pr-3 text-2xl leading-8 text-gray-400 font-medium">Users /</a> Delete
        ...
        <div class="bg-white p-6 rounded-lg flex flex-col">
            ...
            <div class="flex flex-col lg:flex-row justify-center lg:justify-start items-center gap-4 pb-4">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p>Are you sure that you want to delete this user with email : <span class="italic font-medium text-red-400"><?php echo e($userEmail); ?></span> ?</p>
                </div>
            </div>
            <div class="bg-gray-50 flex justify-between lg:justify-end gap-3 py-3 px-6 rounded">
                <div class="w-full lg:w-4/12 flex items-center gap-4">
                    ...
                    <form action="/admin-panel/users/delete" method="post" class="w-6/12">
...
<?php echo $__env->make("layouts.admin-panel.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\koori\session16 MVC\index2 Main\main\resources\views/user/admin-panel/users/admin-panel-users-delete.blade.php ENDPATH**/ ?>