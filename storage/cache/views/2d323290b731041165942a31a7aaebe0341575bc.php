        ...
        <div class="bg-white p-6 rounded-lg flex flex-col">
            ...
            <div class="bg-gray-50 py-3 px-6 rounded">
                <div class="w-full flex items-center gap-4">
                    <form action="/panel/delete" method="post" class="sm:w-3/12 w-full ml-auto">
...
<?php echo $__env->make("layouts.user-panel.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\koori\1_PHP\session9 MVC\index2 Main\main\resources\views/user/panel/delete/delete.blade.php ENDPATH**/ ?>