                    ...
                    <div class="flex flex-col justify-between grow">
                        ...
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="-mx-2 space-y-1">
                                ...
                                <a href="/"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
                                ...
                                <a href="/panel"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/panel") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
                                ...
                                <a href="/panel/orders"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/panel/orders") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
                                ...
                                <a href="/panel/change-password"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/panel/change-password") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
                                ...
                                <a href="/panel/delete"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/panel/delete") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
                        ...
                        <div class="-mx-2">
                            ...
                            <a href="/panel/logout"
                                class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/panel/logout") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
            ...
            <div class="h-full w-full bg-gray-50">
                ...
                <div class="border-b-1 flex flex-col lg:flex-row gap-4 md:gap-0 justify-between items-center p-6">
                    ...
                    <div>
                        ...
                        <span class="font-black text-gray-900 text-2xl text-center"><?php echo $__env->yieldContent('page','Dashboard'); ?></span>
                    </div>
                ...
                <div class="p-6 bg-white border-b-1">
                    <h2 class="font-bold text-3xl text-gray-900"><?php echo $__env->yieldContent("header","Dashboard"); ?></h2>
                </div>
...
</html><?php /**PATH C:\Users\Lenovo\Desktop\koori\1_PHP\session9 MVC\index2 Main\main\resources\views/layouts/user-panel/master.blade.php ENDPATH**/ ?>