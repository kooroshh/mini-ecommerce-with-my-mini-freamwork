        ...
        <div class="bg-white p-6 rounded-lg flex flex-col">
            ...
            <div class="flex flex-col lg:flex-row justify-center lg:justify-start items-center gap-4 pb-4">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p>Are you sure that you want to delete this product with slug : <span class="italic font-medium text-red-400"><?php echo e($productSlug); ?></span> ?</p>
                </div>
            </div>
...
<?php echo $__env->make("layouts.admin-panel.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\koori\session16 MVC\index2 Main\main\resources\views/user/admin-panel/products/admin-panel-products-delete.blade.php ENDPATH**/ ?>