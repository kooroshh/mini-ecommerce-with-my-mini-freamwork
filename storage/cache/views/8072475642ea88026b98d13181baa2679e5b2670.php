                        ...
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="-mx-2 space-y-1">
                                ...
                                <a href="/admin-panel/users"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/admin-panel/users") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
