                    ...
                    <div class="flex flex-col justify-between grow">
                        ...
                        <div class="flex flex-col gap-7">
                            ...
                            <div class="-mx-2 space-y-1">
                                ...
                                <a href="#"
                                    class="font-semibold text-sm rounded-md flex gap-3 items-center p-2 text-gray-200 <?php echo e(request()->is("/admin-panel/team") ? "bg-indigo-700" : "hover:bg-indigo-700"); ?>">
