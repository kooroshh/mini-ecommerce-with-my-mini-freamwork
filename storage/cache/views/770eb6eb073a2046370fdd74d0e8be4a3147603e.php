...
<?php $__env->startSection("page"); ?>
    <a href="/admin-panel/unregistered-comments" class="pr-3 text-2xl leading-8 text-gray-400 font-medium">Users /</a> Register Comment
    ...
    <div class="p-3">
        ...
        <div class="bg-white w-full mt-4 p-2">
            <div class="w-full lg:w-4/12 ml-auto mr-2 flex items-center gap-4">
                <a href="/admin-panel/unregistered-comments/delete?<?php echo e($data->id); ?>" class="text-white bg-red-600 py-2 px-3 rounded text-center w-6/12">Delete</a>
                <form action="/admin-panel/unregistered-comments/register" method="post" class="w-6/12">
                    ...
                    <input type="hidden" name="commentsId" value="<?php echo e($data->id); ?>">
...
<?php echo $__env->make("layouts.admin-panel.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\koori\session16 MVC\index2 Main\main\resources\views/user/admin-panel/comments/admin-panel-comments-register.blade.php ENDPATH**/ ?>