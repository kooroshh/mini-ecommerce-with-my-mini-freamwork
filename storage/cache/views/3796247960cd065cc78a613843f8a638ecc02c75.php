...
<?php $__env->startSection('content'); ?>
    ...
    <div class="px-4">
        ...
        <div class="mt-10 lg:p-10 sm:p-8 p-3">
            <img class="rounded-lg object-cover sm:w-9/12 mx-auto" src="<?php echo e(image('games.webp')); ?>" alt="Games">
        </div>
        ...
        <div class="mt-20">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-stretch text-center gap-y-3 w-full lg:px-10 mt-10">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="/products?categories[]=<?php echo e($category->name); ?>" class="block">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="/products/<?php echo e($product->slug); ?>" class="block">
                        <div class="bg-white border border-gray-200 rounded-lg overflow-hidden flex flex-col">
                            ...
                            <img class="sm:h-96 object-cover hover:scale-105 transition duration-500 bg-gray-200" src="<?php echo e(image($product->image, "products")); ?>" alt="Product Image">
...
<?php echo $__env->make("layouts.complete", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\koori\1_PHP\session9 MVC\index2 Main\main\resources\views/home/home.blade.php ENDPATH**/ ?>