        ...
        <form class="space-y-6" action="/admin-panel/products/edit" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div>
                ...
                <div class="mt-2 bg-white py-3 px-6 flex flex-wrap gap-7 items-center rounded-md">
                    <?php
                        $oldCategories = $product->categories;
                    ?>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <?php if(!empty($oldCategories)): ?>
                            <?php $__currentLoopData = $oldCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $value2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <?php if($value2 == $value->name): ?>
