...
<?php $__env->startSection("content"); ?>
    ...
    <div class="px-3 py-4 flex">
        ...
        <div class="w-7/12">
            ...
            <img class="object-cover bg-gray-100 rounded-lg w-full h-auto" src="<?php echo e(image($product->image, "products")); ?>" alt="Product Image">
        ...
        <div class="w-5/12 px-2">
            ...
            <div class="space-y-5 divide-y-2">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm mt-2 ml-1"><?php echo e(explode(' ', $product->created_at)[0]); ?></p>
                    <p class="text-gray-900  tracking-tight text-3xl mt-2">$<?php echo e($product->price); ?></p>
                    <p class="mt-2 text-gray-900 tracking-tight text-xl">Stock :<?php echo e($product->count); ?></p>
                    <p class="text-gray-500 my-6 w-full bg-gray-50 p-2 rounded-md"><?php echo e($product->description); ?></p>
                    <a href="/products/add?id=<?php echo e($product->id); ?>" class="block w-full bg-indigo-600 text-white text-center px-8 py-3 rounded-md">Add To Shopping Cart</a> 
                </div>
                <div class="pt-3">
